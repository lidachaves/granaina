...
const CallToAction = () => {
  return (
    <div className="max-w-7xl bg-white rounded-lg overflow-hidden shadow-md relative mx-auto h-80 border border-black transition duration-300 ease-in-out hover:shadow-2xl hover:bg-yellow-100">
