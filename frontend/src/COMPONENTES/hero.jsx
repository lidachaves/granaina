...
const GoodHero = () => {
  return (
    <section className="relative px-4 py-24 mx-auto bg-cover bg-center h-screen"
    style={{
      backgroundImage: `url("https://i.pinimg.com/originals/07/21/7f/07217f42fd465f0b3f8079dc921b4cf4.jpg")`, // Reemplaza con tu URL de imagen
    }}
    >
